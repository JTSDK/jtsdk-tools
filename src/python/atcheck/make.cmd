::-----------------------------------------------------------------------------::
:: Name .........: make.cmd
:: Project ......: JTSDK-Tools (atcheck)
:: Description ..: Windows Makefile (make.cmd)
:: Project URL ..: https://github.com/ki7mt/jtsdk-tools/src/python/atcheck
::
...
:: Make File Variables
SET app_name=atcheck
SET pypitest=--repository-url https://test.pypi.org/legacy/ dist/*
SET test_install=-i https://test.pypi.org/simple/ atcheck
SET prod_install=-i https://pypi.org/simple/ atcheck
