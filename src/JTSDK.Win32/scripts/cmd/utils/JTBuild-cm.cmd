...
:: generate default.txt file if not exist --------------------------------------
:DEFAULT_TEXT
IF NOT EXIST %JTSDK_HOME%\tmp\default.txt (

mkdir %JTSDK_HOME%\tmp >NUL 2>&1

>%JTSDK_HOME%\tmp\default.txt (
...
ECHO --------------------------------------------
ECHO.
ECHO  A file named %JTSDK_HOME%\tmp\default.txt
...
ECHO  as appropriate.
ECHO. 
ECHO  After verifying the default.txt file, re-run
ECHO  your commands.
ECHO.
GOTO EOF
